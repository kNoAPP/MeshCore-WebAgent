...
export const IDENTITY_TOP_FRAME_CLASS = {
  none: '',
  teal: 'border-t-3 border-t-identity-frame-teal',
  lime: 'border-t-3 border-t-identity-frame-lime',
  amber: 'border-t-3 border-t-identity-frame-amber',
  orange: 'border-t-3 border-t-identity-frame-orange',
  pink: 'border-t-3 border-t-identity-frame-pink',
  violet: 'border-t-3 border-t-identity-frame-violet',
