 ...
 * both advertise affordances — the action bar's {@link AdvertMenu} and the
 * Settings "Share my node" {@link ShareCard} — gate their buttons on. The flag
 * lives in the store so the two surfaces share one busy lock and can't fire
